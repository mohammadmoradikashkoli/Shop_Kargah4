...
(1, 'ali', '2024-04-07', 2, 200, 80000, '09144042510', 'Ø®ÙˆØ²Ø³ØªØ§Ù† Ø¯Ø²ÙÙˆÙ„ Ø®ÛŒØ§Ø¨Ø§Ù† Ø¹Ø§Ø±Ù Ø¯Ø²ÙÙˆÙ„ÛŒ Ø¨ÛŒÙ† Ø®ÛŒØ§Ø¨Ø§Ù† Ø¨Ù‡Ø´ØªÛŒ Ùˆ Ø®ÛŒØ§Ø¨Ø§Ù† Ø­Ø¶Ø±Øª Ø±Ø³ÙˆÙ„ (Øµ) Ù¾Ù„Ø§Ú© 92', '000000000000000000000000', 0);
...
('Dear manager', 'admin', 'admin', 'admin@moder.ir', 1),
('maharam valipor', 'Ali', '1127', 'Ali@amir.ir', 0),
('Ù…Ø­Ø±Ù… ÙˆÙ„ÛŒ Ù¾ÙˆØ±', 'moharram', '1127', 'maharamvalipor@yahoo.com', 0);
COMMIT;
